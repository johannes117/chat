...
export function SidebarProvider({ children, defaultState = "expanded" }: SidebarProviderProps) {
  ...
  return (
    <SidebarContext.Provider value={{ state, toggle, collapse, expand }}>
...
export {
  SidebarGroupActionOld as SidebarGroupAction,
  SidebarGroupLabelOld as SidebarGroupLabel,
  SidebarInputOld as SidebarInput,
  SidebarInsetOld as SidebarInset,
  SidebarMenuActionOld as SidebarMenuAction,
  SidebarMenuBadgeOld as SidebarMenuBadge,
  SidebarMenuButtonOld as SidebarMenuButton,
  SidebarMenuSkeletonOld as SidebarMenuSkeleton,
  SidebarMenuSubOld as SidebarMenuSub,
  SidebarMenuSubButtonOld as SidebarMenuSubButton,
  SidebarMenuSubItemOld as SidebarMenuSubItem,
  SidebarRailOld as SidebarRail,
  SidebarSeparatorOld as SidebarSeparator,
}
